...
# But this is only the *Task*'s name! The robot doesn't know what to do from that sentence alone. We can define the steps needed to complete the *Tas*k underneath in the `***Tasks***` cell.
